...
_gitlib_gen_colors_memories() {
    local file=~/.home/themes/memories/.config/git/colors
...
'green bold reverse'
    ...
    git config --file $file color.diff.context 'white'
    ...
    git config --file $file color.status.header 'white'
    git config --file $file color.status.localBranch 'green bold'
    git config --file $file color.status.nobranch 'blue'
    git config --file $file color.status.remoteBranch 'magenta bold'
    git config --file $file color.status.unmerged 'red'
    git config --file $file color.status.untracked 'red'
